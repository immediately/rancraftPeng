...
{
    final int MAXHEALTHWILD = 30; // same as zombie
    /* automatically compute the four terciles */
    int healthTercile1 = (int)((float)MAXHEALTHWILD * 0.25) + 1;
    int healthTercile2 = (int)((float)MAXHEALTHWILD * 0.50) + 1;
    int healthTercile3 = (int)((float)MAXHEALTHWILD * 0.75) + 1;
    ...
    {
		return RanCraftPenguins.PengSkinRed.itemID;
    }
    ...
    {
    	return worldObj.difficultySetting > 0 && this.worldObj.checkNoEntityCollision(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(this.boundingBox);
    }
    ...
    public boolean interactShearing(EntityPlayer par1EntityPlayer)
    {
    	if (!worldObj.isRemote)
        {
	        ...
	        if (itemstack != null && itemstack.itemID == RanCraftPenguins.PenguinShears.itemID)
	        {
	        ...
	        if (itemstack != null && itemstack.itemID == RanCraftPenguins.FishMagma.itemID)
	        {
    ...
    protected boolean isDisguised(EntityPlayer entityplayer1)
    {
        ...
        if ((inventoryplayer1.armorItemInSlot(3) != null && 
					(inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatEmp.itemID 
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatKing.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatYE.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatMag.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatLB.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatWF.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatGal.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinHatAdel.itemID
					|| inventoryplayer1.armorItemInSlot(3).itemID == RanCraftPenguins.PenguinFlameMask.itemID))
			 && (inventoryplayer1.armorItemInSlot(2) != null && 
			        (inventoryplayer1.armorItemInSlot(2).itemID == RanCraftPenguins.PenguinTunic.itemID
			        || inventoryplayer1.armorItemInSlot(2).itemID == RanCraftPenguins.PenguinFlameChestPlate.itemID))
			 && (inventoryplayer1.armorItemInSlot(1) != null && 
			        (inventoryplayer1.armorItemInSlot(1).itemID == RanCraftPenguins.PenguinPants.itemID
			        || inventoryplayer1.armorItemInSlot(1).itemID == RanCraftPenguins.PenguinFlameLeggings.itemID))
			 && (inventoryplayer1.armorItemInSlot(0) != null && 
			        (inventoryplayer1.armorItemInSlot(0).itemID == RanCraftPenguins.PenguinFlippers.itemID
			        || inventoryplayer1.armorItemInSlot(0).itemID == RanCraftPenguins.PenguinFlameFlippers.itemID
			        || inventoryplayer1.armorItemInSlot(0).itemID == RanCraftPenguins.PenguinBootsCloud.itemID)) )
        {
