...
public class EntityPenguinNinj extends EntityMob implements IRangedAttackMob
{
    ...
    {
        return RanCraftPenguins.PenguinShuriken.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(RanCraftPenguins.PenguinShuriken.itemID, 1);
        }
        ...
        {
            this.dropItem(RanCraftPenguins.PenguinKatanaD.itemID, 1);
        }
    }
