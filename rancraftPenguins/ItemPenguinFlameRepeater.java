...
public class ItemPenguinFlameRepeater extends ItemBow {
	...
	public ItemPenguinFlameRepeater(int par1) {
		super(par1);
        maxStackSize = 1;
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
	    ...
	    {
	        float var7 = 1.5F; // velocity multiplier
    ...
    {
    	return RanCraftPenguins.PengScaleRed.itemID == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
    }
}
