...
//            ModelBase, ModelRenderer, EntityPenguinCS, MathHelper, 
//            Entity, EntityLiving

public class ModelPenguinCS extends ModelBase
{
  ...
  public ModelPenguinCS()
  {
      ...
      /* side, down (neg is up), back (neg is forward), Second set is dimensions! */ 
  ...
  public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
{
  ...
  public void setLivingAnimations(EntityLivingBase entityliving, float f, float f1, float f2)
  {
    ...
    EntityPenguinCS entitypenguin = (EntityPenguinCS)entityliving;
	...
	if (entitypenguin.isSitting()) // sitting
    {
       ...
       if(entitypenguin.isInWater()){ // swimming, so horizontal and flap
	        ...
	        if (!entitypenguin.onGround || MathHelper.abs((float)entitypenguin.motionY) > 0.1F) // || entitypenguin.isAirBorne) <= Most of the time!
	        {
		        ...
		        rightwing.rotateAngleZ = pi / 16.0F;
		        ...
		        if(speedSum < 0.2F){ // standing or slow walk
			        ...
			        rightwing.rotateAngleY = pi / 2.5F;
