...
public class ModelPenguinMag extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLivingBase entityliving, float f, float f1, float f2)
    {
        ...
        EntityPenguinMag entitypenguin = (EntityPenguinMag)entityliving;
