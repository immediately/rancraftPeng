...
//            ModelBase, ModelRenderer, EntityPenguinYE, MathHelper, 
//            Entity, EntityLiving
...
public class ModelPenguinYE extends ModelBase
{
    ...
    public ModelPenguinYE()
    {
        ...
        rightfoot.addBox(-1F, 3F, -2F, 2, 1, 5);
        rightleg.addChild(rightfoot);
        leftfoot = new ModelRenderer(this, 0, 28);
        leftfoot.addBox(-1F, 3F, -2F, 2, 1, 5);
    ...
    public void setLivingAnimations(EntityLivingBase entityliving, float f, float f1, float f2)
    {
        ...
        EntityPenguinYE entitypenguin = (EntityPenguinYE)entityliving;
