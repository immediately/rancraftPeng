...
public class RenderPenguin extends RenderLiving
{
	...
	protected ResourceLocation func_110914_a(EntityPenguin par1EntityPenguin)
    {
        ResourceLocation retVal;
        
        if(par1EntityPenguin.isChild()){
        	retVal = par1EntityPenguin.isTamed() ? skinPengChildTame : skinPengChild;
        } else { // adult
        	retVal = par1EntityPenguin.isTamed() ? skinPengTame : (par1EntityPenguin.isAngry() ? skinPengAngry : skinPeng);
        }
        //return par1EntityPenguin.isTamed() ? skinPengTame : (par1EntityPenguin.isAngry() ? skinPengAngry : skinPeng);
        return retVal;
    }
